...
# invoking acr module to create acr to ask cluster
module "acr_with_cluster" {
  # invoke acr module under modules directory
  source = "../modules/acr"

  name = var.container_registry_name
  resource_group_name = module.vnet_with_subnets.az_rg_name
  region = var.region
  principal_id = module.aks_with_node_group.kubelet_identity_object_id
}